...
partition by list (dimension)(
    partition part_2d values ('2D'),
    partition part_3d values ('3D')
);
...
PARTITION BY RANGE (id_show) (
    PARTITION p0 VALUES LESS THAN (6000),
    partition p1 values less than (12000),
    partition p2 values less than (18000),
    partition p3 values less than (24000)
);
