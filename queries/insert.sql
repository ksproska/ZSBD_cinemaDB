...
FROM TEMP, TEMP T2, SHOWS, (SELECT ID_SHOW AS LAST_ID_SHOW FROM (SELECT ID_SHOW FROM SHOWS ORDER BY ID_SHOW DESC) WHERE ROWNUM <= 1) WHERE ID_SHOW = :selected_show
